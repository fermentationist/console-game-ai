...
console.log(
  !prefsAreSet ? "no user preferences detected." : "user preferences applied."
);

export let primaryFont =
  localStorage.getItem("ConsoleGame.prefs.font") || defaultFont;
export let textColor =
  localStorage.getItem("ConsoleGame.prefs.color") || defaultTextColor;
export let fontSize =
  localStorage.getItem("ConsoleGame.prefs.size") || defaultFontSize;
