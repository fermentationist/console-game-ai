export default game => {
  return {
    ...
    contents: [],
    get description() {
      return `The modest wooden dresser is of simple design. The pale blue milk paint that coats it is worn through in several spots from use. It has a large drawer, which is ${
