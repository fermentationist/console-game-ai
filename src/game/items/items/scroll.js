export default game => {
  return {
    ...
    use() {
      game.log.p(
        'You unfurl the scroll and read aloud the text on the inside surface. As you finish, the text fades away, and the scroll disappears! You have memorized "rezrov", an incantation capable of opening locked or closed things.'
      );
      this.listed = false;
    },
    cast() {
